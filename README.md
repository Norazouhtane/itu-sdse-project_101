...
The `pipeline.go` file ensures that the correct requirements are installed from the `requirements.txt` after which it runs the .py files from *itu_mlops_project_101* folder in the following order:
